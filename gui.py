...
class Gui:
    def __init__(self,window):
        ...
        """self.radio_one = Radiobutton(self.frame_shape, text='one', variable=self.radio_score, value=1,
                                        command=self.submit)
        self.radio_two = Radiobutton(self.frame_shape, text='two', variable=self.radio_score, value=2,
                                        command=self.submit)
        self.radio_three = Radiobutton(self.frame_shape, text='three', variable=self.radio_score, value=3,
                                           command=self.submit)
        self.radio_four = Radiobutton(self.frame_shape, text='four', variable=self.radio_score, value=4,
                                          command=self.submit)
    ...
    def submit(self):
        with open('data.csv', 'w', newline='') as csvfile:
            ...
            content.writerow(["Name", "Score1", "Score2", "Score3", "Score4"])
        try:
            ...
            with open('data.csv', 'a', newline='') as csvfile:
                ...
                self.radio_score.set(0)
                self.label_bellow.config(text='Scores saved')
